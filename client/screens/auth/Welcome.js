    ...
    <View style={styles.signInContainer}>
      ...
      <View style={styles.txtContainer}>
        <Text style={styles.headerTxt}>
          Trusted Companion for Seamless Communication
        </Text>
        <Text style={styles.discTxt}>
          {" "}
          ሰላም Chat is a powerful chat app designed for effortless communication.
          With its user-friendly interface and advanced features, ሰላም Chat makes
          it easy to connect with your friends, family, and colleagues in
          real-time.
        </Text>
        <View style={styles.btnContainer}>
          ...
          >
            <Button
              ...
              onPress={() =>
                navigation.navigate("signup", { transition: "slideFromLeft" })
              }
            />
          </TouchableHighlight>
          <TouchableHighlight
          ...
          >
            <Button
              ...
              accessibilityLabel="Learn more about this button"
              onPress={() =>
                navigation.navigate("signin", { transition: "slideFromRight" })
              }
            />
          </TouchableHighlight>
        </View>
